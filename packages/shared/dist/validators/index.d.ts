...
export declare const variableSchema: z.ZodObject<{
    ...
    mapsTo: z.ZodOptional<z.ZodEnum<["name", "email", "phone", "none"]>>;
}, "strip", z.ZodTypeAny, {
    ...
    mapsTo?: "name" | "email" | "phone" | "none" | undefined;
}, {
    type: "string" | "number" | "boolean" | "enum";
    name: string;
    description: string;
...
export declare const agentCreateSchema: z.ZodObject<{
    ...
    webConfig: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
}, "strip", z.ZodTypeAny, {
    name: string;
    systemPrompt: string;
    ...
    webConfig?: Record<string, unknown> | undefined;
}, {
    name: string;
    systemPrompt: string;
    llmProvider: "openai" | "anthropic";
...
export declare const agentUpdateSchema: z.ZodObject<{
    ...
    variables: z.ZodOptional<z.ZodOptional<z.ZodArray<z.ZodObject<{
        name: z.ZodString;
        type: z.ZodEnum<["string", "enum", "number", "boolean"]>;
        required: z.ZodDefault<z.ZodBoolean>;
        description: z.ZodString;
    ...
    webConfig: z.ZodOptional<z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>>;
}, "strip", z.ZodTypeAny, {
