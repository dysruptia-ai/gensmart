...
1. **Reads the full conversation** — every message from both the user and the agent
2. **Extracts captured variables** — name, email, service interest, budget
3. **Analyzes sentiment and intent** — using the same LLM models that power your agents
4. **Generates a 0-10 score** with a written summary explaining the reasoning
5. **Updates the CRM automatically** — no manual work needed
