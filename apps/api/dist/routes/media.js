...
const MAX_IMAGE_BYTES = media_validator_service_1.MEDIA_LIMITS.image.maxSizeBytes;
/**
...
router.get('/proxy', async (req, res) => {
    ...
    if ((0, media_validator_service_1.isHostBlocked)(parsed.hostname)) {
    ...
    try {
        ...
        res.status(502).json({ error: `Could not fetch upstream: ${err.message}` });
    }
});
